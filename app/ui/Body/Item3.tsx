...
const Item3= ({ name, tag, quantity, price, stars }: {name: string, tag: string, quantity: number, price: string, stars: number}) => {
    ...
    return (
        <div style={{width: '100%', height: '25%', paddingLeft: 16, paddingRight: 16, justifyContent: 'flex-start', alignItems: 'flex-start', gap: 72, display: 'inline-flex'}}>
            ...
            <div style={{marginLeft: 'auto', display: 'flex', flexDirection: 'row', alignItems: 'flex-end', gap: 220, paddingRight: 170}}>
